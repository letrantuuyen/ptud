...
public class FormHDNH extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        textField1.setHintText("Tìm hóa đơn");

        button1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/loupe.png"))); // NOI18N

        button2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/file.png"))); // NOI18N
        ...
        jLabel1.setText("Danh Sách Hóa Đơn Nhập Hàng");
