...
public class TabbedPane extends JTabbedPane {
    ...
    public static class TabbedPaneUI extends BasicTabbedPaneUI {
        ...
        protected void paintTabArea(Graphics g, int tabPlacement, int selectedIndex) {
            ...
            g2d.setPaint(new GradientPaint(0, 0, defaultColorSet.topGradColor1, 0, 30, defaultColorSet.topGradColor2));
            g2d.fillRect(0, 0, tabPane.getWidth(), 15);

            g2d.setPaint(new GradientPaint(0, 15, defaultColorSet.bottomGradColor1, 0, 30, defaultColorSet.bottomGradColor2));
            g2d.fillRect(0, 15, tabPane.getWidth(), 16);
            super.paintTabArea(g, tabPlacement, selectedIndex);

            if (contentTopBorderDrawn) {
                g2d.setColor(lineColor);
                g2d.drawLine(0, 30, tabPane.getWidth() - 1, 30);
            }
        }
        ...
        protected void paintTabBackground(Graphics g, int tabPlacement,
            ...
            g2d.fillRect(xpos, 0, width, 15);

            g2d.setPaint(new GradientPaint(0, 15, colorSet.bottomGradColor1, 0, 31, colorSet.bottomGradColor2));
            g2d.fillRect(xpos, 15, width, 16);

            if (contentTopBorderDrawn) {
                g2d.setColor(lineColor);
                g2d.drawLine(rect.x, 30, rect.x + rect.width - 1, 30);
            }
        }
        ...
        protected void paintTabBorder(Graphics g, int tabPlacement, int tabIndex,
            ...
            g.drawLine(rect.x + rect.width, 0, rect.x + rect.width, 30);
        }
        ...
        private class RollOverListener implements MouseMotionListener,
            ...
            private void checkRollOver() {
                ...
                if (currentRollOver != lastRollOverTab) {
                    ...
                    Rectangle tabsRect = new Rectangle(0, 0, tabPane.getWidth(), 30);
